...
namespace AMWin_RichPresence
{
    public static class Constants
    {
        ...
        public static string ApplicationStylisedName = "AMWin-RichPresence (Private Mode)";
        ...
        public static string GithubReleasesApiUrl = "https://api.github.com/repos/ImMysteries/AMWin-RP/releases/latest";
        public static string GithubReleasesUrl = "https://github.com/ImMysteries/AMWin-RP/releases";
        public static string GithubRepoUrl = "https://github.com/ImMysteries/AMWin-RP";
